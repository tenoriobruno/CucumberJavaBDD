...
Funcionalidade: Pesquisa de livro
  ...
  Cenario: Pesquisar livros por ano de publicação
    Dado um livro com o título 'Um bom livro', escrito por 'Qualquer autor', publicado em 14 Março 2013
      E  um outro livro com o título 'Algum outro livro', escrito por 'João Damião', publicado em 23 Dezembro 2014
      E  um outro livro com o título 'Como cozinhar um dino', escrito por 'Fred Flintstone', publicado em 01 Maio 2012
